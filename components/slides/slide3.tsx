...
const Slide3 = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full min-h-screen bg-gradient-to-br from-blue-50 to-white dark:from-gray-900 dark:to-gray-800">
      {/* Sección de texto y en móvil también los iconos */}
      <div className="w-full lg:w-2/5 flex flex-col items-center p-8 lg:p-12">
        ...
        {/* Iconos en móvil/tablet */}
        <div className="lg:hidden lg:w-3/5 w-full mt-8  p-8 lg:p-12 dark:from-gray-900 dark:to-gray-800">
          <div className="flex flex-wrap  gap-4">
            {features.map((feature, index) => (
              <div key={index} className="flex flex-col ">
                <feature.icon className="h-8 w-8 text-gray-800 dark:text-gray-200" />
                <span className="text-xs text-gray-800 dark:text-gray-200 mt-1">
                  {feature.name}
                </span>
              </div>
            ))}
          </div>
          <p className="text-foreground italic mt-6 text-sm">
            Y muchas otras marcas disponibles...
          </p>
        </div>
      </div>

      {/* Sección de iconos (solo en desktop) */}
      <div className="hidden lg:flex w-full lg:w-3/5 items-center justify-center p-8 lg:p-12 bg-background">
